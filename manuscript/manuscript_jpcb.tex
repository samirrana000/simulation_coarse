...
\begin{figure*}[t]
\centering
\includegraphics[width=6.8in]{figures/fig1_overview.pdf}
...
\begin{figure*}[t]
\centering
\includegraphics[width=6.8in]{figures/fig2_pmf_free_energy.pdf}
...
\begin{figure*}[t]
\centering
\includegraphics[width=6.8in]{figures/fig3_kinetics_tpt.pdf}
...
\begin{figure*}[t]
\centering
\includegraphics[width=6.8in]{figures/fig4_performance.pdf}
...
All source code, WebGPU compute pipelines, automated test suites, and molecular coordinate benchmarks are open-source and freely available under the MIT License at \url{https://github.com/samirr/simulation_coarse} and archived as version \texttt{v1.0-jpcb} on Zenodo (\url{https://doi.org/10.5281/zenodo.XXXXXXX}, DOI placeholder \texttt{10.5281/zenodo.XXXXXXX} until deposition; see \texttt{CITATION.cff} and \texttt{docs/CITATION.md}). The repository is structured as follows:
\begin{itemize}
